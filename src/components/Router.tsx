...
import { BlogPythonNamedTuple, BlogPythonFirstOrderFunctions, BlogPythonDunders,
    ...
    BlogPythonFunctions, BlogPythonGenerators } from './content';
    ...
    public render() {
        return (
            <Switch>
                ...
                <Route path="/portfolio-app/blog_7" component={BlogPythonFunctions}/>
                <Route path="/portfolio-app/blog_8" component={BlogPythonGenerators}/>
            </Switch>
        );
    }
}